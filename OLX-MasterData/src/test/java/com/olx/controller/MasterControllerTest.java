...
public class MasterControllerTest {
	...
	void getCategoryTest_success() throws JsonProcessingException, Exception {
		...
		mockMvc.perform(get("/advertiseApp/advertise/category").contentType("application/json"))
	...
	void getStatusTest_success() throws JsonProcessingException, Exception {
		...
		mockMvc.perform(get("/advertiseApp/advertise/status").contentType("application/json"))
			.andExpect(status().isFound())
			.andExpect(content().string(containsString("Shahab")))
			.andReturn();
	}
	...
	void getCategoryByIdTest_success() throws JsonProcessingException, Exception {
		...
		mockMvc.perform(get("/advertiseApp/advertise/category/"+id).contentType("application/json"))
			.andExpect(status().isFound())
			.andExpect(content().string(containsString("Shahab")))
			.andReturn();
	}
	...
	void getAdvertiseStatusByIdTest_success() throws JsonProcessingException, Exception {
		...
		mockMvc.perform(get("/advertiseApp/advertise/advertiseStatus/"+id).contentType("application/json"))
			.andExpect(status().isFound())
			.andExpect(content().string(containsString("Shahab")))
			.andReturn();
	}
